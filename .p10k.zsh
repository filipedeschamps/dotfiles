# Generated by Powerlevel10k configuration wizard on 2022-03-03 at 19:24 PST.
# Based on romkatv/powerlevel10k/config/p10k-lean.zsh, checksum 11390.
# Wizard options: compatible, unicode, lean, 2 lines, dotted, no frame, light-ornaments,
